...
// Technology icons (not present skillicons)
...
const projects = [
  {
    ...
    description: (
      <>
        <span className="font-semibold">Gorr</span> is a sophisticated
        microservices-based deployment platform designed to streamline project
        deployments with real-time monitoring, efficient resource management,
  ...
  },
  {
    ...
    description: (
      <>
        <div className="mb-3">
          <span className="font-semibold">Heimdall</span> is a comprehensive
          ping and uptime monitoring platform designed to eliminate cold starts
          on free hosting platforms like <b>Render</b>, <b>Railway</b>, and{" "}
          <b>Fly.io</b>. By intelligently pinging your backend servers at
          customizable intervals, Heimdall ensures optimal performance while
          providing detailed analytics and instant alerts.
        </div>
      </>
    ),
    technologies: [
            ...
            {isYouTubeEmbed(items[current]) ? (
              <div className="relative w-full flex items-center justify-center">
                <iframe
                  className={
                    videoClassName ||
                    "rounded-[8px] w-full max-h-[350px] object-contain shadow-lg"
                  }
                  src={items[current]}
        ...
        {projects.map((project, idx) => {
          ...
          return (
            <div
              ...
              } md:items-center md:gap-8 mb-12`}
            >
              {/* Mobile layout */}
              <div className="flex flex-col w-full md:hidden">
                ...
                <div className="flex flex-row font-[var(--min-weight)] code-live-btn-container gap-3 flex-wrap mb-2">
                  ...
                  >
                    <span className="text-white text-[clamp(16px,1.1vw,20px)]">
                      Code
                    </span>
                    {/* ...icon svg... */}
                  </a>
                  ...
                  >
                    ...
                    <div
                      className="circle pulse green inline-block ml-2"
                      style={{
                        width: "12px",
                        height: "12px",
                        borderRadius: "50%",
