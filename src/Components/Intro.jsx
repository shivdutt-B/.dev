            ...
            <div class="grid grid-cols-2 max-w-[1000px] w-[100%]">
                <div class="">
                    <h1 class="text-[clamp(30px,10vw,40px)] font-[var(--max-weight)] text-[var(--dark-txt)] mb-4">
                        ...
                        online
                        <br />
                        by dropshipping with
                        <br />
                        Spocket
                    </h1>
                    <p class="text-[var(--light-txt)] mb-8 text-[clamp(16px,1.2vw,20px)]">
                        Spocket allows you to choose the best products to sell from thousands of dropshipping suppliers all over the world. Start your 14 day trial and make money from home.
                    </p>
                    <button class="font-[var(--min-weight)] bg-[var(--theme-color)]
                    text-white font-bold py-2 px-4 rounded-lg shadow-md hover:bg-purple-700 transition duration-300">
