...
import Me from "../assets/Mmain7.png";
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 max-w-[1200px] w-[100%] gap-8">
                ...
                <div className="flex text-center justify-center flex-col order-1 md:text-left">
                    ...
                    text-white py-2 px-4 rounded-md hover:bg-purple-700 transition duration-300 shadow-[0_3px_8px_rgba(0,0,0,0.6)] w-[130px] md:mx-0">
                        ...
                        <svg className="inline font-[var(--mid-weight)]" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path d="M12.5535 16.5061C12.4114 16.6615 12.2106 16.75 12 16.75C11.7894 16.75 11.5886 16.6615 11.4465 16.5061L7.44648 12.1311C7.16698 11.8254 7.18822 11.351 7.49392 11.0715C7.79963 10.792 8.27402 10.8132 8.55352 11.1189L11.25 14.0682V3C11.25 2.58579 11.5858 2.25 12 2.25C12.4142 2.25 12.75 2.58579 12.75 3V14.0682L15.4465 11.1189C15.726 10.8132 16.2004 10.792 16.5061 11.0715C16.8118 11.351 16.833 11.8254 16.5535 12.1311L12.5535 16.5061Z" fill="#fff"></path>
                ...
                <div className="flex justify-center md:justify-center md:hidden"><img src={Me} alt="Shivdutt Bhadakwad" className="max-w-[300px] w-[100%] md:max-w-[350px]" /></div>
            </div>
        </div>
    );
}
